...
function PasswordWidget(divid,pwdname)
{
  ...
  this.txtWeak='Password strenght: Too Weak';
...
function _MakePWDWidget()
{
  ...
  code += "<input type='password' minlength='5' maxlength='15' placeholder='Password' onblur='check_password_status(this.value)' class='form-control padpas' name='"+pwdname+"' id='"+this.forminputbigid+"' data-validate='required'>";

  this.pwdtxtfield=pwdname+"_text";

  this.pwdtxtfieldid = this.pwdtxtfield+"_id";

  code += "<input type='text' minlength='5' maxlength='15'  placeholder='Password' onblur='check_password_status(this.value)' class='form-control padpas' name='"+this.pwdtxtfield+"' id='"+this.pwdtxtfieldid+"' style='display: none;' data-validate='required'>";
