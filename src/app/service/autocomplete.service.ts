...
export class AutocompleteService {
    ...
    getHotelCities(city: string) {
        return this.http.get<any>(myGlobals.ExternalURL + 'hotel/get_hotel_city_autosuggestions?term=' +
            city + '&token=6a201e52-9211-4954-b657-17a3af95cee9')
            .pipe(map(currency => {
                return currency;
            }));
    }
